...
export const doctors: Doctor[] = [
  {
    ...
    email: 'sarah.johnson@medlens.ai',
...
export const patients: Patient[] = [
  {
    ...
    address: '42 Crescent Ave, Boston, MA',
    emergencyContact: 'Thomas Vance (+1 555-912-3499)',
    insuranceInfo: 'Aetna Platinum AP-8819',
    status: 'In Treatment',
    assignedDoctorId: 'd1',
  },
  {
